...
if __name__ == '__main__':
    ...
    with tempfile.TemporaryDirectory() as local_dir:
        repo = input("Enter the GitHub URL of the repository: ")
        if clone_github_repo(repo, local_dir):
            index, documents, file_type_counts, filenames = load_and_index_files(local_dir)
            if index is None:
    ...
    print(search_documents("How do I install this?", index, documents))